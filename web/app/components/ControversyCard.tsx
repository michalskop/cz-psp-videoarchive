    ...
    >
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="px-5 pt-4 pb-5 flex flex-col gap-3">
          {/* Badge */}
          <div>
            <span className="inline-flex items-center bg-orange-6 text-surface-0 font-sans font-bold text-[10px] uppercase tracking-widest px-2.5 py-1 rounded-badge-sm">
